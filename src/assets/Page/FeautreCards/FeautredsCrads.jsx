...
const FeautredsCrads = ({food}) => {
    ...
    return (
        <div>
            <div className="w-full max-w-sm overflow-hidden h-[600px] bg-gray-500 rounded-lg shadow-lg dark:bg-gray-800">
    <img className="object-cover object-center w-full h-56" src={food_image} alt="avatar"/>

    <div className="flex items-center px-6 py-3 bg-orange-900">
    ...
    <div className="px-6 py-4">
      ...
      <img className="w-[50px] h-[50px] rounded-full border-4 " src={donator?.image} alt="" />
          <h1 className="text-xl font-roboto text-white font-semibold drop-shadow-lg  dark:text-white">{donator?.name}</h1>

      </div>
        <p className="py-2 drop-shadow-lg text-xl text-white font-roboto hover:text-orange-500 dark:text-gray-400">{additional_notes}</p>

        <div className="flex items-center mt-4  text-white dark:text-gray-200">
            <svg aria-label="suitcase icon" className="w-6  hover:text-orange-500 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="px-2  hover:text-orange-500 text-sm">Food Quantity: {food_quantity}</h1>
        </div>

        <div className="flex items-center mt-4  text-white dark:text-gray-200">
            <svg aria-label="location pin icon" className="w-6  hover:text-orange-500 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h1 className="px-2 hover:text-orange-500  text-white text-sm">Pickup Location: {pickup_location}</h1>
        </div>

        <div className="flex items-center mt-4  text-white dark:text-gray-200">
           

          <FcExpired className='text-2xl text-black hover:text-orange-500'>  </FcExpired>
          <h1 className="px-2 hover:text-orange-500 text-sm">{expired_date}</h1>
        </div>
        <button className='bg-orange-500 text-white font-bold px-2 py-2 mt-2 rounded w-full'>View Details</button>
    </div>
</div>
        </div>
    );
