...
const FeautredsCrads = ({food}) => {
    ...
    <div className="px-6 py-4">
      ...
      <img className="w-[50px] h-[50px] rounded-full border-4 " src={donator?.image} alt="" />
          <h1 className="text-xl font-roboto font-semibold drop-shadow-lg text-orange-500 dark:text-white">{donator?.name}</h1>

      </div>
        <p className="py-2 drop-shadow-lg text-gray-700 font-roboto hover:text-orange-500 dark:text-gray-400">{additional_notes}</p>
        ...
        <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
            ...
            <h1 className="px-2 hover:text-orange-500 text-sm">{pickup_location}</h1>
        </div>
